...
public class LoanAccount extends Activity implements OnClickListener{
	...
	public void addAccounts(String all_accstr, String acc_type) 
	{
		...
		try 
		{
			...
			else
			{
				...
				Toast.makeText(getApplicationContext(), getString(R.string.alert_089), Toast.LENGTH_LONG).show();
	...
	public void onClick(View v) {
		...
		else if(v.getId()==R.id.btnShowDetails)
		{
			...
			Bundle b = new Bundle();
			Intent in = new Intent(LoanAccount.this,LoanAccountDetails.class);
